        ...
        return (
            <div>
                <div style={{"display":this.state.show ? "block" : "none"}}>
                    <MyToast children = {{show : this.state.show, message:"Question saved Succesfully."}}/>
                </div>
                <Card className={""}>
                    <Card.Header>Add Question</Card.Header>
                    <Form onReset={this.resetQuestion} onSubmit={this.submitQuestion} id={"questionId"}>
                        <Card.Body>
